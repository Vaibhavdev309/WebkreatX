...
function requestOptions(dlNumber, dob) {
  return {
    ...
    headers: {
      ...
      "X-RapidAPI-Key": "97865cf999msh716dbfae1df3fc4p153400jsnd34bbdb7d7f5",
  ...
  return (
    <div className="w-full h-full">
      <div className="max-w-md mx-auto mt-8 p-6 bg-white rounded-md shadow-md my-auto ">
        {!Verify && (
          <div
            className="mt-[70px] bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
            role="alert"
          >
